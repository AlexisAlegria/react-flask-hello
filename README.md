...
## NOTES by Alexis Alegría:

- Steps to run Front-end:

1. npm install
2. check your local python version. Boilerplate was defined with python_version = "3.8". In my case is 3.10. So change that value on Pipfile file.
3. pipenv install
4. pipenv shell
